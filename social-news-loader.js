// =====================================================
//  Social News Loader — Φορτώνει άρθρα κοινωνικών δράσεων
//  από content/data/social.json για τη σελίδα /social
// =====================================================
...
(function () {
  ...
  const CATEGORY_LABELS = {
    ...
    schools:      { el: "Σχολικές Επισκέψεις", en: "School Visits" },
    beach:        { el: "Παραλιακές Δράσεις", en: "Beach Initiatives" },
    family:       { el: "Οικογένεια Κ.Ο.Κ.",  en: "K.O.K. Family" },
    other:        { el: "Δράση",              en: "Action" }
  };
  ...
  async function load() {
    if (!cache) {
      try {
        const res = await fetch("content/data/social.json", { cache: "no-cache" });
